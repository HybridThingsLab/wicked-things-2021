...
public void setup() {
  ...
  h1.oscP5 = new OscP5(this, 8888);
  h2.oscP5 = new OscP5(this, 8888);
  // send messages
  ...
  // start value px, py, TODO check (fixed)
  //joystick1
